import { TransactionExecutionStatus, TransactionFinalityStatus, TransactionType } from "starknet";
import { array, Infer, nullable, number, object, string, enums } from "superstruct";
...
export type StarkScanTransactionsResponse = Infer<typeof StarkScanTransactionsResponseStruct>,
