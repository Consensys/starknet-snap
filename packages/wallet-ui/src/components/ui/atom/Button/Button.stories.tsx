...
export const Success = () => (
  <ButtonView variant="success">Success Button</ButtonView>
);
...
export const Disabled = () => (
  <ButtonView enabled={false}>Info Button</ButtonView>
);

export const ActionClick = () => (
  <ButtonView onClick={() => alert('Clicked!')}>Action Button</ButtonView>
);
